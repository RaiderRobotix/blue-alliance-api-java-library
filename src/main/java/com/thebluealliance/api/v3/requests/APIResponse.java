...
/**
 * Holds a response from The Blue Alliance API com.thebluealliance.api.v3
 */
public class APIResponse {
    ...
    /**
     * @return The date and time the data returned was last updated. Used by clients in the `If-Modified-Since`
     * request header.
     */
     ...
     * header is used, 401 if no TBA com.thebluealliance.api.v3 API Key was provided, or it is not valid, or 404 if
