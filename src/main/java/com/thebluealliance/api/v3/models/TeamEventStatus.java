...
public class TeamEventStatus {
	...
	*/
	...
	/**
	* @return An HTML formatted string suitable for display to the user containing the team�s overall status summary
	* of the event.
	*/
    ...
    @Value public class Alliance {
	    ...
	    */
         ...
         */
        @Value public class AllianceBackup {
             String out, in;
    ...
    @Value public class PlayoffStatus {
         String level;
	    String record;
	    String status;}
